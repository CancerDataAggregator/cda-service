...
public class FileSqlGeneratorTest {
    ...
    void testQuery(
        ...
        String translatedQuery = new FileSqlGenerator(qualifiedTable, query, table).generate();
