...
public class EntityCountSqlGeneratorTest {
    ...
    void testQuery(
        ...
        Constructor<? extends EntityCountSqlGenerator> ct = clazz.getDeclaredConstructor(String.class, Query.class,
                String.class);
        String translatedQuery = ct.newInstance(qualifiedTable, query, table).generate().build().getQuery();
