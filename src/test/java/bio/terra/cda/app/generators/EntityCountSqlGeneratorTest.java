...
public class EntityCountSqlGeneratorTest {
  ...
  void testQuery(
    ...
    Constructor<? extends EntityCountSqlGenerator> ct =
        clazz.getDeclaredConstructor(TableSchema.class, String.class, Query.class, String.class);
    TableSchema tableSchema = TableSchemaHelper.getNewTableSchema("v3");
    String translatedQuery =
        ct.newInstance(tableSchema, qualifiedTable, query, table).generate().build().getQuery();
