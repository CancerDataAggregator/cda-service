...
public class ParameterBuilderTest {
    ...
    void testAddParameterDuplicates() throws IOException {
        Schemas schemas = new Schemas.SchemaBuilder(
                "all_Subjects_v3_0_final", "all_Files_v3_0_final").build();
        ParameterBuilder builder = new ParameterBuilder(schemas.getSchemaMap(), schemas.getFileSchemaMap());
