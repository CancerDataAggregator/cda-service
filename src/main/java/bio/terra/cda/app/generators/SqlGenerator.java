...
public class SqlGenerator {
  ...
  protected String sql(
    ...
    String results = subQuery ? queryResult : SqlTemplate.resultsWrapper(queryResult,offsetandLimitString);
  ...
  /**
   * This code checks if the "limit" or "offset" values are set in the "ctx" object.
   * If they are, it appends the values to a string and returns it.
   * @param ctx
   * @return
   */
