...
@QueryGenerator(
    ...
    hasFiles = true,
    defaultOrderBy = "researchsubject_id",
    aggregatedFields = {"researchsubject_identifier_system"},
    aggregatedFieldsSelectString = {
      "json_agg(distinct (researchsubject_identifier.system, researchsubject_identifier.field_name, researchsubject_identifier.value)::system_data) as researchsubjet_identifier",
