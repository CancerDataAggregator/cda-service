...
public class QueryContext {
    ...
    public QueryContext(Map<String, TableSchema.SchemaDefinition> tableSchemaMap, String tableOrSubClause, String table,
                        String project, String fileTable, Map<String, TableSchema.SchemaDefinition> fileTableSchemaMap) {
